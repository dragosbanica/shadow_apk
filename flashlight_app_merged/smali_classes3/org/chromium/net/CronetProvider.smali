...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/chromium/net/CronetProvider$a;
    }
.end annotation
...
.method private static addCronetProviderFromResourceFile(Landroid/content/Context;Lorg/chromium/net/impl/b$c;Ljava/util/Set;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/content/Context;",
            "Lorg/chromium/net/impl/b$c;",
            "Ljava/util/Set<",
            "Lorg/chromium/net/CronetProvider$a;",
            ">;)Z"
        }
    ...
    invoke-static {p0, v0, p1, p2, v1}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/b$c;Ljava/util/Set;Z)Z
...
.method private static addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/b$c;Ljava/util/Set;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Lorg/chromium/net/CronetProvider$a;

    invoke-direct {v1}, Lorg/chromium/net/CronetProvider$a;-><init>()V
    ...
    iput-object p0, v1, Lorg/chromium/net/CronetProvider$a;->a:Lorg/chromium/net/CronetProvider;

    iput-object p2, v1, Lorg/chromium/net/CronetProvider$a;->b:Lorg/chromium/net/impl/b$c;
...
.method public static getAllProviderInfos(Landroid/content/Context;)Ljava/util/List;
    ...
    sget-object v1, Lorg/chromium/net/impl/b$c;->a:Lorg/chromium/net/impl/b$c;

    invoke-static {p0, v1, v0}, Lorg/chromium/net/CronetProvider;->addCronetProviderFromResourceFile(Landroid/content/Context;Lorg/chromium/net/impl/b$c;Ljava/util/Set;)Z

    sget-object v1, Lorg/chromium/net/impl/b$c;->c:Lorg/chromium/net/impl/b$c;

    const-string v2, "com.google.android.gms.net.PlayServicesCronetProvider"

    const/4 v3, 0x0

    invoke-static {p0, v2, v1, v0, v3}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/b$c;Ljava/util/Set;Z)Z
    ...
    invoke-static {p0, v1, v2, v0, v3}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;Lorg/chromium/net/impl/b$c;Ljava/util/Set;Z)Z
...
.method public static getAllProviders(Landroid/content/Context;)Ljava/util/List;
    ...
    check-cast v1, Lorg/chromium/net/CronetProvider$a;

    iget-object v1, v1, Lorg/chromium/net/CronetProvider$a;->a:Lorg/chromium/net/CronetProvider;
