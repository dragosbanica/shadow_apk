...
.method private static createBuilderDelegate(Landroid/content/Context;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    invoke-static {p0, v4}, Lorg/chromium/net/CronetEngine$Builder;->getEnabledCronetProviders(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v4, Lorg/chromium/net/CronetProvider$a;

    iget-object v5, v4, Lorg/chromium/net/CronetProvider$a;->b:Lorg/chromium/net/impl/b$c;

    invoke-static {p0, v5}, Lorg/chromium/net/impl/c;->a(Landroid/content/Context;Lorg/chromium/net/impl/b$c;)Lorg/chromium/net/impl/b;

    move-result-object p0

    new-instance v5, Lorg/chromium/net/impl/b$b;

    invoke-direct {v5}, Lorg/chromium/net/impl/b$b;-><init>()V
    :try_end_0
    ...
    iput-object v6, v5, Lorg/chromium/net/impl/b$b;->e:Ljava/lang/Boolean;

    sget-object v6, Lorg/chromium/net/impl/b$b$a;->a:Lorg/chromium/net/impl/b$b$a;

    iput-object v6, v5, Lorg/chromium/net/impl/b$b;->b:Lorg/chromium/net/impl/b$b$a;

    iget-object v6, v4, Lorg/chromium/net/CronetProvider$a;->b:Lorg/chromium/net/impl/b$c;

    iput-object v6, v5, Lorg/chromium/net/impl/b$b;->d:Lorg/chromium/net/impl/b$c;

    invoke-static {}, Landroid/os/Process;->myUid()I

    move-result v6

    iput v6, v5, Lorg/chromium/net/impl/b$b;->h:I

    new-instance v6, Lorg/chromium/net/impl/b$e;

    invoke-static {}, Lorg/chromium/net/ApiVersion;->getCronetVersion()Ljava/lang/String;

    move-result-object v7

    invoke-direct {v6, v7}, Lorg/chromium/net/impl/b$e;-><init>(Ljava/lang/String;)V

    iput-object v6, v5, Lorg/chromium/net/impl/b$b;->f:Lorg/chromium/net/impl/b$e;
    ...
    const-string v6, "Using \'%s\' provider for creating CronetEngine.Builder."

    iget-object v7, v4, Lorg/chromium/net/CronetProvider$a;->a:Lorg/chromium/net/CronetProvider;
    ...
    :cond_0
    :goto_0
    iget-object v0, v4, Lorg/chromium/net/CronetProvider$a;->a:Lorg/chromium/net/CronetProvider;
    ...
    invoke-direct {v6, v4}, Lorg/chromium/net/impl/b$e;-><init>(Ljava/lang/String;)V

    iput-object v6, v5, Lorg/chromium/net/impl/b$b;->g:Lorg/chromium/net/impl/b$e;
    ...
    iput-wide v6, v5, Lorg/chromium/net/impl/b$b;->a:J

    sget-object v4, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v4, v5, Lorg/chromium/net/impl/b$b;->e:Ljava/lang/Boolean;
    :try_end_1
    ...
    iput v2, v5, Lorg/chromium/net/impl/b$b;->c:I

    invoke-virtual {p0, v5}, Lorg/chromium/net/impl/b;->b(Lorg/chromium/net/impl/b$b;)V
    :try_end_2
...
.method public static getEnabledCronetProviders(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v0, Lorg/chromium/net/CronetProvider$a;

    iget-object v0, v0, Lorg/chromium/net/CronetProvider$a;->a:Lorg/chromium/net/CronetProvider;
...
.method private static synthetic lambda$setConnectionMigrationOptions$2(Lorg/chromium/net/ConnectionMigrationOptions;Lorg/json/JSONObject;)V
    ...
    invoke-static {p1, p0}, Lorg/chromium/net/g;->b(Lorg/json/JSONObject;Lorg/chromium/net/ConnectionMigrationOptions;)V
...
.method private static synthetic lambda$setDnsOptions$1(Lorg/chromium/net/DnsOptions;Lorg/json/JSONObject;)V
    ...
    invoke-static {p1, p0}, Lorg/chromium/net/g;->d(Lorg/json/JSONObject;Lorg/chromium/net/DnsOptions;)V
...
.method private static synthetic lambda$setQuicOptions$0(Lorg/chromium/net/QuicOptions;Lorg/json/JSONObject;)V
    ...
    invoke-static {p1, p0}, Lorg/chromium/net/g;->e(Lorg/json/JSONObject;Lorg/chromium/net/QuicOptions;)V
...
.method private maybeSetExperimentalOptions()V
    ...
    invoke-static {v0, v1}, Lorg/chromium/net/g;->a(Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;
...
.method public setConnectionMigrationOptions(Lorg/chromium/net/ConnectionMigrationOptions;)Lorg/chromium/net/CronetEngine$Builder;
    ...
    invoke-direct {v1, p1}, Lorg/chromium/net/d;-><init>(Lorg/chromium/net/ConnectionMigrationOptions;)V
...
.method public setDnsOptions(Lorg/chromium/net/DnsOptions;)Lorg/chromium/net/CronetEngine$Builder;
    ...
    new-instance v1, Lorg/chromium/net/e;

    invoke-direct {v1, p1}, Lorg/chromium/net/e;-><init>(Lorg/chromium/net/DnsOptions;)V
...
.method public setQuicOptions(Lorg/chromium/net/QuicOptions;)Lorg/chromium/net/CronetEngine$Builder;
    ...
    invoke-direct {v1, p1}, Lorg/chromium/net/c;-><init>(Lorg/chromium/net/QuicOptions;)V
