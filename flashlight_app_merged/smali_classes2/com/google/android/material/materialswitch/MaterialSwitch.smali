...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-super {p0}, Landroidx/appcompat/widget/X;->getThumbDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-super {p0}, Landroidx/appcompat/widget/X;->getThumbTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/X;->setThumbTintList(Landroid/content/res/ColorStateList;)V

    invoke-super {p0}, Landroidx/appcompat/widget/X;->getTrackDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-super {p0}, Landroidx/appcompat/widget/X;->getTrackTintList()Landroid/content/res/ColorStateList;
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/X;->setTrackTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/google/android/material/internal/ThemeEnforcement;->obtainTintedStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroidx/appcompat/widget/c0;
    ...
    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/c0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p2, p3, v0}, Landroidx/appcompat/widget/c0;->k(II)I
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/X;->setEnforceSwitchWidth(Z)V
...
.method private refreshThumbDrawable()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/X;->getThumbTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-super {p0, v0}, Landroidx/appcompat/widget/X;->setThumbDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private refreshTrackDrawable()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/X;->getTrackTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/X;->setSwitchMinWidth(I)V

    :cond_2
    invoke-super {p0, v0}, Landroidx/appcompat/widget/X;->setTrackDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private static setInterpolatedDrawableTintIfPossible(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;[I[IF)V
    ...
    invoke-static {p2, p1, p4}, LF/d;->c(IIF)I

    move-result p1

    invoke-static {p0, p1}, LG/a;->n(Landroid/graphics/drawable/Drawable;I)V
...
.method private updateDrawableTints()V
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/appcompat/widget/X;->getThumbPosition()F
...
.method public onCreateDrawableState(I)[I
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/X;->onCreateDrawableState(I)[I
...
.method public setThumbTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/X;->setThumbTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setTrackTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/X;->setTrackTintMode(Landroid/graphics/PorterDuff$Mode;)V
