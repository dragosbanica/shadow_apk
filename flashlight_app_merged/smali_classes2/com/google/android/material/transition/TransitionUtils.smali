...
.method public static maybeAddTransition(Landroidx/transition/q;Landroidx/transition/m;)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Landroidx/transition/q;->x(Landroidx/transition/m;)Landroidx/transition/q;

    :cond_0
    return-void
.end method

.method public static maybeApplyThemeDuration(Landroidx/transition/m;Landroid/content/Context;I)Z
    .locals 4
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/transition/m;->setDuration(J)Landroidx/transition/m;
...
.method public static maybeApplyThemeInterpolator(Landroidx/transition/m;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
...
.method public static maybeApplyThemePath(Landroidx/transition/m;Landroid/content/Context;I)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/m;->setPathMotion(Landroidx/transition/g;)V
...
.method public static maybeRemoveTransition(Landroidx/transition/q;Landroidx/transition/m;)V
    .locals 0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Landroidx/transition/q;->G(Landroidx/transition/m;)Landroidx/transition/q;

    :cond_0
    return-void
.end method

.method public static resolveThemePath(Landroid/content/Context;I)Landroidx/transition/g;
    .locals 3
    ...
    invoke-static {p0}, LF/g;->e(Ljava/lang/String;)Landroid/graphics/Path;
