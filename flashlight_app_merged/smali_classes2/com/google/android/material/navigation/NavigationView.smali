...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/c0;->s(I)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/c0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-static {v0, v2}, LO/T;->u0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    :cond_0
    sget v2, Lcom/google/android/material/R$styleable;->NavigationView_drawerLayoutCornerSize:I

    invoke-virtual {v1, v2, v12}, Landroidx/appcompat/widget/c0;->f(II)I
    ...
    invoke-virtual {v1, v2, v12}, Landroidx/appcompat/widget/c0;->k(II)I
    ...
    invoke-static {v0, v4}, LO/T;->u0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, v2, v12}, Landroidx/appcompat/widget/c0;->a(IZ)Z
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/c0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v3, v12}, Landroidx/appcompat/widget/c0;->n(II)I
    ...
    invoke-virtual {v1, v6}, Landroidx/appcompat/widget/c0;->s(I)Z

    move-result v7

    if-eqz v7, :cond_8

    invoke-virtual {v1, v6}, Landroidx/appcompat/widget/c0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v6, v12}, Landroidx/appcompat/widget/c0;->n(II)I
    ...
    invoke-virtual {v1, v7}, Landroidx/appcompat/widget/c0;->s(I)Z

    move-result v8

    if-eqz v8, :cond_a

    invoke-virtual {v1, v7, v12}, Landroidx/appcompat/widget/c0;->f(II)I
    ...
    invoke-virtual {v1, v7}, Landroidx/appcompat/widget/c0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v8}, Landroidx/appcompat/widget/c0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    if-nez v8, :cond_d

    invoke-direct {v0, v1}, Lcom/google/android/material/navigation/NavigationView;->hasShapeAppearance(Landroidx/appcompat/widget/c0;)Z

    move-result v9

    if-eqz v9, :cond_d

    invoke-direct {v0, v1}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemBackground(Landroidx/appcompat/widget/c0;)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    sget v9, Lcom/google/android/material/R$styleable;->NavigationView_itemRippleColor:I

    invoke-static {v13, v1, v9}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/c0;I)Landroid/content/res/ColorStateList;

    move-result-object v9

    if-eqz v9, :cond_d

    invoke-direct {v0, v1, v4}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(Landroidx/appcompat/widget/c0;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v4}, Landroidx/appcompat/widget/c0;->s(I)Z

    move-result v9

    if-eqz v9, :cond_e

    invoke-virtual {v1, v4, v12}, Landroidx/appcompat/widget/c0;->f(II)I
    ...
    invoke-virtual {v1, v4, v9}, Landroidx/appcompat/widget/c0;->a(IZ)Z
    ...
    invoke-virtual {v1, v9, v11}, Landroidx/appcompat/widget/c0;->k(II)I
    ...
    invoke-virtual {v1, v2, v12}, Landroidx/appcompat/widget/c0;->n(II)I
...
.method private createDefaultItemBackground(Landroidx/appcompat/widget/c0;)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-static {v0, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/c0;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(Landroidx/appcompat/widget/c0;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
...
.method private createDefaultItemDrawable(Landroidx/appcompat/widget/c0;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    .locals 9
    ...
    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/c0;->f(II)I
...
.method private hasShapeAppearance(Landroidx/appcompat/widget/c0;)Z
    .locals 1
...
.method private maybeUpdateCornerSizeForDrawerLayout(II)V
    ...
    invoke-static {v2, v3}, LO/o;->b(II)I
...
.method public onInsetsChanged(LO/e0;)V
    .locals 1
    ...
    .line 2
    .line 3
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter;->dispatchApplyWindowInsets(LO/e0;)V
