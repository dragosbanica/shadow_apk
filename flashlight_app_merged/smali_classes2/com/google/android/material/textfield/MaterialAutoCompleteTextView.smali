...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p3, p1}, Landroidx/appcompat/widget/O;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/O;->H(Z)V

    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/O;->B(Landroid/view/View;)V

    const/4 p1, 0x2

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/O;->G(I)V

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/O;->n(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/O;->J(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method private measureContentWidth()I
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/O;->v()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/O;->g()Landroid/graphics/drawable/Drawable;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/O;->n(Landroid/widget/ListAdapter;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/O;->K(Landroid/widget/AdapterView$OnItemSelectedListener;)V
