...
.field private touchExplorationStateChangeListener:LP/c$b;


# direct methods
.method public constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/c0;)V
    .locals 6
    ...
    invoke-direct {v4, p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout$EndIconDelegates;-><init>(Lcom/google/android/material/textfield/EndCompoundLayout;Landroidx/appcompat/widget/c0;)V
    ...
    invoke-direct {v4, v5}, Landroidx/appcompat/widget/C;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->suffixTextView:Landroid/widget/TextView;

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initErrorIconView(Landroidx/appcompat/widget/c0;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initEndIconView(Landroidx/appcompat/widget/c0;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initSuffixTextView(Landroidx/appcompat/widget/c0;)V
...
.method private addTouchExplorationStateChangeListenerIfNeeded()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LP/c$b;
    ...
    invoke-static {p0}, LO/T;->T(Landroid/view/View;)Z
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LP/c$b;

    invoke-static {v0, v1}, LP/c;->a(Landroid/view/accessibility/AccessibilityManager;LP/c$b;)Z
...
.method private createIconView(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;I)Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {p2, v1}, LO/r;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method private initEndIconView(Landroidx/appcompat/widget/c0;)V
    .locals 6
    ...
    invoke-static {v4, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/c0;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v1, v3}, Landroidx/appcompat/widget/c0;->k(II)I
    ...
    invoke-virtual {p1, v1, v5}, Landroidx/appcompat/widget/c0;->k(II)I
    ...
    :cond_5
    invoke-virtual {p1, v0, v5}, Landroidx/appcompat/widget/c0;->a(IZ)Z
...
.method private initErrorIconView(Landroidx/appcompat/widget/c0;)V
    .locals 2
    ...
    invoke-static {v1, p1, v0}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/c0;I)Landroid/content/res/ColorStateList;
...
.method private initSuffixTextView(Landroidx/appcompat/widget/c0;)V
    .locals 4
    ...
    invoke-static {v0, v1}, LO/T;->s0(Landroid/view/View;I)V
...
.method private removeTouchExplorationStateChangeListenerIfNeeded()V
    ...
    invoke-static {v1, v0}, LP/c;->b(Landroid/view/accessibility/AccessibilityManager;LP/c$b;)Z
...
.method private setUpDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/textfield/EndIconDelegate;->getTouchExplorationStateChangeListener()LP/c$b;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LP/c$b;
...
.method private tearDownDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LP/c$b;
...
.method private tintEndIconOnError(Z)V
    ...
    invoke-static {p1}, LG/a;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v0}, LG/a;->n(Landroid/graphics/drawable/Drawable;I)V
...
.method public updateSuffixTextViewPadding()V
    ...
    invoke-static {v1, v2, v3, v0, v4}, LO/T;->G0(Landroid/view/View;IIII)V
