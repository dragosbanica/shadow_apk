...
.method public final zad(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p2, p1, p3}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroidx/fragment/app/w;Ljava/lang/String;)V
...
.method public final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    new-instance v3, LB/m$d;

    invoke-direct {v3, p1}, LB/m$d;-><init>(Landroid/content/Context;)V

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, LB/m$d;->k(Z)LB/m$d;

    move-result-object v3

    invoke-virtual {v3, v4}, LB/m$d;->e(Z)LB/m$d;

    move-result-object v3

    invoke-virtual {v3, p3}, LB/m$d;->i(Ljava/lang/CharSequence;)LB/m$d;

    move-result-object p3

    new-instance v3, LB/m$b;

    invoke-direct {v3}, LB/m$b;-><init>()V

    invoke-virtual {v3, v0}, LB/m$b;->h(Ljava/lang/CharSequence;)LB/m$b;

    move-result-object v3

    invoke-virtual {p3, v3}, LB/m$d;->o(LB/m$e;)LB/m$d;
    ...
    invoke-virtual {p3, v0}, LB/m$d;->n(I)LB/m$d;

    move-result-object v0

    invoke-virtual {v0, v5}, LB/m$d;->m(I)LB/m$d;
    ...
    invoke-virtual {p3, v0, v1, p4}, LB/m$d;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)LB/m$d;

    goto :goto_0

    :cond_3
    invoke-virtual {p3, p4}, LB/m$d;->g(Landroid/app/PendingIntent;)LB/m$d;
    ...
    invoke-virtual {p3, v3}, LB/m$d;->n(I)LB/m$d;
    ...
    invoke-virtual {v3, v1}, LB/m$d;->p(Ljava/lang/CharSequence;)LB/m$d;
    ...
    invoke-virtual {v1, v6, v7}, LB/m$d;->q(J)LB/m$d;

    move-result-object v1

    invoke-virtual {v1, p4}, LB/m$d;->g(Landroid/app/PendingIntent;)LB/m$d;

    move-result-object p4

    invoke-virtual {p4, v0}, LB/m$d;->h(Ljava/lang/CharSequence;)LB/m$d;
    ...
    invoke-static {v0, p1, p4}, Lo1/c;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p1

    invoke-static {v2, p1}, Lo1/b;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
    ...
    invoke-static {v2, p4}, Lo1/b;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    :cond_7
    :goto_1
    invoke-virtual {p3, v0}, LB/m$d;->f(Ljava/lang/String;)LB/m$d;

    :goto_2
    invoke-virtual {p3}, LB/m$d;->b()Landroid/app/Notification;
