...
.method public constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/d;->f()LU0/a;
    ...
    invoke-direct {p3, p1, p2, v0}, LN0/d;-><init>(Landroid/content/Context;LU0/a;LN0/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/b;->d:LN0/d;
...
.method public a()V
    ...
    invoke-interface {v0}, LR0/q;->h()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->d:LN0/d;
    ...
    iget-object v5, v4, LR0/p;->a:Ljava/lang/String;

    invoke-virtual {v4}, LR0/p;->a()J
    ...
    invoke-virtual {v4}, LR0/p;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/b;->d:LN0/d;

    invoke-virtual {v6, v5}, LN0/d;->c(Ljava/lang/String;)Z
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->d:LN0/d;

    invoke-virtual {v0}, LN0/d;->e()V
