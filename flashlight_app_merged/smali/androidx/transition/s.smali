...
.method public static a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {p1, v0}, Landroidx/transition/B;->i(Landroid/view/View;Landroid/graphics/Matrix;)V

    invoke-static {p0, v0}, Landroidx/transition/B;->j(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-static {p1, v0, p2, p0}, Landroidx/transition/s;->b(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
...
.method public static b(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    .line 1
    sget-boolean v0, Landroidx/transition/s;->a:Z
    ...
    :goto_0
    sget-boolean v3, Landroidx/transition/s;->b:Z
    ...
    sget-boolean p2, Landroidx/transition/s;->c:Z
    ...
    invoke-static {p2}, Landroidx/transition/r;->a(Landroid/graphics/Picture;)Landroid/graphics/Bitmap;
