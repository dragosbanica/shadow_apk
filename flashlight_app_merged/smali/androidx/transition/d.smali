...
.method public constructor <init>(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/O;->setMode(I)V

    return-void
.end method

.method public static u(Landroidx/transition/t;F)F
    .locals 1
...
.method public captureStartValues(Landroidx/transition/t;)V
    ...
    invoke-super {p0, p1}, Landroidx/transition/O;->captureStartValues(Landroidx/transition/t;)V

    iget-object v0, p1, Landroidx/transition/t;->a:Ljava/util/Map;

    iget-object p1, p1, Landroidx/transition/t;->b:Landroid/view/View;

    invoke-static {p1}, Landroidx/transition/B;->c(Landroid/view/View;)F
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/t;Landroidx/transition/t;)Landroid/animation/Animator;
    ...
    invoke-static {p3, p1}, Landroidx/transition/d;->u(Landroidx/transition/t;F)F
    ...
    :goto_0
    invoke-virtual {p0, p2, p1, p4}, Landroidx/transition/d;->t(Landroid/view/View;FF)Landroid/animation/Animator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroidx/transition/t;Landroidx/transition/t;)Landroid/animation/Animator;
    ...
    invoke-static {p2}, Landroidx/transition/B;->e(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p2, p1, p3}, Landroidx/transition/d;->t(Landroid/view/View;FF)Landroid/animation/Animator;
...
.method public final t(Landroid/view/View;FF)Landroid/animation/Animator;
    .locals 2
    ...
    :cond_0
    invoke-static {p1, p2}, Landroidx/transition/B;->g(Landroid/view/View;F)V

    sget-object p2, Landroidx/transition/B;->b:Landroid/util/Property;
    ...
    invoke-virtual {p0, p3}, Landroidx/transition/m;->addListener(Landroidx/transition/m$g;)Landroidx/transition/m;
