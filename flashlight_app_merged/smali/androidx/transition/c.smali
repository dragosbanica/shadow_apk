...
.field public static k:Landroidx/transition/k;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/c;->k:Landroidx/transition/k;
...
.method public captureEndValues(Landroidx/transition/t;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/c;->captureValues(Landroidx/transition/t;)V
...
.method public final captureValues(Landroidx/transition/t;)V
    .locals 7
    ...
    invoke-static {v0}, LO/T;->u(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/t;Landroidx/transition/t;)Landroid/animation/Animator;
    ...
    invoke-virtual {v8, v5, v6}, Landroidx/transition/c;->s(Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-boolean v10, v8, Landroidx/transition/c;->b:Z

    if-nez v10, :cond_12

    move-object/from16 v10, v17

    invoke-static {v10, v7, v12, v14, v5}, Landroidx/transition/B;->f(Landroid/view/View;IIII)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroidx/transition/g;->getPath(FFFF)Landroid/graphics/Path;
    ...
    :goto_6
    invoke-static {v10, v1, v0}, Landroidx/transition/f;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    :cond_e
    new-instance v0, Landroidx/transition/c$k;

    invoke-direct {v0, v10}, Landroidx/transition/c$k;-><init>(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v2, v3, v4, v7}, Landroidx/transition/g;->getPath(FFFF)Landroid/graphics/Path;

    move-result-object v1

    sget-object v2, Landroidx/transition/c;->f:Landroid/util/Property;

    invoke-static {v0, v2, v1}, Landroidx/transition/f;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {v2, v3, v4, v5, v6}, Landroidx/transition/g;->getPath(FFFF)Landroid/graphics/Path;

    move-result-object v2

    sget-object v3, Landroidx/transition/c;->g:Landroid/util/Property;

    invoke-static {v0, v3, v2}, Landroidx/transition/f;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v1, Landroidx/transition/c$h;

    invoke-direct {v1, v8, v0}, Landroidx/transition/c$h;-><init>(Landroidx/transition/c;Landroidx/transition/c$k;)V
    ...
    invoke-static {v10, v7, v12, v1, v5}, Landroidx/transition/B;->f(Landroid/view/View;IIII)V
    ...
    invoke-virtual {v1, v5, v7, v12, v14}, Landroidx/transition/g;->getPath(FFFF)Landroid/graphics/Path;

    move-result-object v1

    sget-object v5, Landroidx/transition/c;->j:Landroid/util/Property;

    invoke-static {v10, v5, v1}, Landroidx/transition/f;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v10, v0}, LO/T;->x0(Landroid/view/View;Landroid/graphics/Rect;)V

    sget-object v1, Landroidx/transition/c;->k:Landroidx/transition/k;
    ...
    new-instance v14, Landroidx/transition/c$i;
    ...
    invoke-static {v1, v2}, Landroidx/transition/y;->c(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v8, v2}, Landroidx/transition/m;->addListener(Landroidx/transition/m$g;)Landroidx/transition/m;
    ...
    invoke-static {v10}, Landroidx/transition/B;->c(Landroid/view/View;)F

    move-result v7

    const/4 v4, 0x0

    invoke-static {v10, v4}, Landroidx/transition/B;->g(Landroid/view/View;F)V

    invoke-static/range {p1 .. p1}, Landroidx/transition/B;->b(Landroid/view/View;)Landroidx/transition/A;

    move-result-object v4

    invoke-interface {v4, v6}, Landroidx/transition/A;->add(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual/range {p0 .. p0}, Landroidx/transition/m;->getPathMotion()Landroidx/transition/g;

    move-result-object v4

    iget-object v9, v8, Landroidx/transition/c;->a:[I
    ...
    invoke-virtual {v4, v2, v0, v3, v1}, Landroidx/transition/g;->getPath(FFFF)Landroid/graphics/Path;

    move-result-object v0

    sget-object v1, Landroidx/transition/c;->e:Landroid/util/Property;

    invoke-static {v1, v0}, Landroidx/transition/i;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
...
.method public final s(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/transition/m;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/t;
