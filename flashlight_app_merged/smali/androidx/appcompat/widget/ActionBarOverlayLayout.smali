...
.field public u:LO/e0;

.field public v:LO/e0;

.field public w:LO/e0;

.field public x:LO/e0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, LO/e0;->b:LO/e0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:LO/e0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LO/e0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LO/e0;
    ...
    invoke-direct {p1, p0}, LO/D;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->E:LO/D;
...
.method public a(Landroid/view/Menu;Landroidx/appcompat/view/menu/m$a;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Landroidx/appcompat/widget/I;

    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/I;->a(Landroid/view/Menu;Landroidx/appcompat/view/menu/m$a;)V
...
.method public c()V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/I;->c()V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->E:LO/D;

    invoke-virtual {v0}, LO/D;->a()I
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/I;->getTitle()Ljava/lang/CharSequence;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Landroidx/appcompat/widget/I;

    invoke-interface {p1}, Landroidx/appcompat/widget/I;->x()V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/I;->w()V
...
.method public i()V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/I;->h()V
...
.method public final n(Landroid/view/View;)Landroidx/appcompat/widget/I;
    .locals 3
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, LO/e0;->x(Landroid/view/WindowInsets;Landroid/view/View;)LO/e0;
    ...
    invoke-static {p0, p1, v1}, LO/T;->f(Landroid/view/View;LO/e0;Landroid/graphics/Rect;)LO/e0;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, LO/e0;->n(IIII)LO/e0;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:LO/e0;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LO/e0;

    invoke-virtual {v2, v1}, LO/e0;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:LO/e0;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LO/e0;
    ...
    :cond_2
    invoke-virtual {p1}, LO/e0;->a()LO/e0;

    move-result-object p1

    invoke-virtual {p1}, LO/e0;->c()LO/e0;

    move-result-object p1

    invoke-virtual {p1}, LO/e0;->b()LO/e0;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, LO/T;->n0(Landroid/view/View;)V
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, LO/T;->M(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->u:LO/e0;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, LO/e0;->n(IIII)LO/e0;

    move-result-object v2

    :goto_2
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    invoke-virtual {v4}, LO/e0;->l()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    invoke-virtual {v5}, LO/e0;->k()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    invoke-virtual {v6}, LO/e0;->i()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, LF/e;->b(IIII)LF/e;

    move-result-object v2

    new-instance v4, LO/e0$b;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    invoke-direct {v4, v5}, LO/e0$b;-><init>(LO/e0;)V

    invoke-virtual {v4, v2}, LO/e0$b;->c(LF/e;)LO/e0$b;

    move-result-object v2

    invoke-virtual {v2}, LO/e0$b;->a()LO/e0;
    ...
    invoke-virtual/range {v4 .. v10}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->k(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LO/e0;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    invoke-virtual {v2, v4}, LO/e0;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LO/e0;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LO/e0;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, LO/T;->g(Landroid/view/View;LO/e0;)LO/e0;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, LO/D;->b(Landroid/view/View;Landroid/view/View;I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/I;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/I;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/I;->m(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/I;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method public t()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->n(Landroid/view/View;)Landroidx/appcompat/widget/I;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Landroidx/appcompat/widget/I;
