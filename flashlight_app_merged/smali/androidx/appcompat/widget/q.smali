...
.method public final a(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v1}, LS/f;->a(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, LS/f;->b(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, v0, v1}, Landroidx/appcompat/widget/k;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/a0;[I)V
...
.method public c()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/q;->l()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v0, v1, v2}, Landroidx/appcompat/widget/k;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/a0;[I)V
...
.method public g(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v3, p2, v1}, Landroidx/appcompat/widget/c0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/c0;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/J;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1, p1}, LS/f;->c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/c0;->k(II)I

    move-result p1

    const/4 p2, 0x0

    invoke-static {p1, p2}, Landroidx/appcompat/widget/J;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p1

    invoke-static {v1, p1}, LS/f;->d(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
