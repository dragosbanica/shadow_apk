...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/J;->a(Landroid/graphics/drawable/Drawable;)Z
...
.method public c(Landroidx/appcompat/widget/S;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Landroidx/appcompat/widget/k$a;->l(Landroidx/appcompat/widget/S;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Lh/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {p0, p2, v4, v5}, Landroidx/appcompat/widget/k$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p2, v0, v3}, Landroidx/appcompat/widget/k$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p2, p1, p3}, Landroidx/appcompat/widget/k$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p2, v0, v4}, Landroidx/appcompat/widget/k$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p2, v3, v4}, Landroidx/appcompat/widget/k$a;->m(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
...
.method public final h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, p2}, LF/d;->g(II)I
...
.method public final k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget-object v3, Landroidx/appcompat/widget/Y;->f:[I

    aput-object v3, v1, v5

    sget v3, Lf/a;->s:I

    invoke-static {p1, v3}, Landroidx/appcompat/widget/Y;->c(Landroid/content/Context;I)I

    move-result v3

    aput v3, v0, v5

    sget-object v3, Landroidx/appcompat/widget/Y;->i:[I
...
.method public final l(Landroidx/appcompat/widget/S;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 6
