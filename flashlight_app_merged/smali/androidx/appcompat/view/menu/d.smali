...
.field public final l:Landroidx/appcompat/widget/P;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->l:Landroidx/appcompat/widget/P;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->u()I
...
.method public b(Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->w(Landroidx/appcompat/view/menu/g;)V
...
.method public dismiss()V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/O;->a()Z
...
.method public f(Landroid/view/View;)V
    ...
    invoke-static {p1}, LO/T;->B(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, LO/o;->b(II)I
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/g;Z)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/d;->r(Landroidx/appcompat/view/menu/g;)I
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/Q;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/Q;->R(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/Q;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/O;->C(I)V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/Q;

    invoke-virtual {v4}, Landroidx/appcompat/widget/O;->a()Z
...
.method public final q()Landroidx/appcompat/widget/Q;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/Q;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->l:Landroidx/appcompat/widget/P;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/Q;->S(Landroidx/appcompat/widget/P;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/O;->J(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/O;->I(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->o:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/O;->B(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->n:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/O;->E(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/O;->H(Z)V
...
.method public final r(Landroidx/appcompat/view/menu/g;)I
    .locals 3
...
.method public final s(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/g;)Landroid/view/MenuItem;
    .locals 4
...
.method public show()V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/view/menu/d;->w(Landroidx/appcompat/view/menu/g;)V
...
.method public final t(Landroidx/appcompat/view/menu/d$d;Landroidx/appcompat/view/menu/g;)Landroid/view/View;
    .locals 7

    .line 1
    iget-object v0, p1, Landroidx/appcompat/view/menu/d$d;->b:Landroidx/appcompat/view/menu/g;

    invoke-virtual {p0, v0, p2}, Landroidx/appcompat/view/menu/d;->s(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/g;)Landroid/view/MenuItem;
...
.method public final w(Landroidx/appcompat/view/menu/g;)V
    .locals 14
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->q()Landroidx/appcompat/widget/Q;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/O;->n(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/O;->D(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->n:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/O;->E(I)V
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/appcompat/view/menu/d;->t(Landroidx/appcompat/view/menu/d$d;Landroidx/appcompat/view/menu/g;)Landroid/view/View;
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/Q;->T(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/Q;->Q(Ljava/lang/Object;)V

    invoke-virtual {p0, v2}, Landroidx/appcompat/view/menu/d;->v(I)I
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/O;->B(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/O;->d(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/O;->L(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/O;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/O;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/O;->F(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/d$d;-><init>(Landroidx/appcompat/widget/Q;Landroidx/appcompat/view/menu/g;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->i:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/O;->show()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/O;->h()Landroid/widget/ListView;
