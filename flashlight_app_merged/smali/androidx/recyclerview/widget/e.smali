...
.method public final c(Landroidx/recyclerview/widget/e$c;J)V
    ...
    invoke-virtual {p0, v2, p1, v0, v1}, Landroidx/recyclerview/widget/e;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$D;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$D;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView$D;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method public final h(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    iget-object v1, p1, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$A;

    iget-object v2, p1, Landroidx/recyclerview/widget/RecyclerView;->mAdapter:Landroidx/recyclerview/widget/RecyclerView$g;

    invoke-virtual {v1, v2}, Landroidx/recyclerview/widget/RecyclerView$A;->f(Landroidx/recyclerview/widget/RecyclerView$g;)V
    ...
    invoke-virtual {p0, p1, v2, p2, p3}, Landroidx/recyclerview/widget/e;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$D;
    :try_end_0
...
.method public final i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$D;
    ...
    invoke-virtual {v0, p2, v1, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$v;->I(IZJ)Landroidx/recyclerview/widget/RecyclerView$D;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$D;->isBound()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$D;->isInvalid()Z
...
.method public run()V
    ...
    invoke-static {v2}, LK/o;->a(Ljava/lang/String;)V
