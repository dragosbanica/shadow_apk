...
.method public static bridge synthetic O()Lads_mobile_sdk/oa;
    .locals 1
...
.method public final a(ILads_mobile_sdk/rp0;)Ljava/lang/Object;
    ...
    sget-object p1, Lads_mobile_sdk/oa;->PARSER:Lb/p8;

    if-nez p1, :cond_1

    const-class p2, Lads_mobile_sdk/oa;
    ...
    sput-object p1, Lads_mobile_sdk/oa;->PARSER:Lb/p8;
    ...
    :cond_4
    new-instance p1, Lb/J8;

    invoke-direct {p1}, Lb/J8;-><init>()V
    ...
    const-string p2, "function_"

    sget-object v0, Lads_mobile_sdk/ta;->a:Lads_mobile_sdk/ta;
