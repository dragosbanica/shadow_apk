.class public final Lads_mobile_sdk/re;
...
.field public final c:Lads_mobile_sdk/p5;
...
.method public constructor <init>(Landroid/content/Context;Lads_mobile_sdk/p5;Lads_mobile_sdk/i53;Lcom/google/common/util/concurrent/ListeningExecutorService;)V
    ...
    iput-object v0, p0, Lads_mobile_sdk/re;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lads_mobile_sdk/re;->f:Lcom/google/common/util/concurrent/ListenableFuture;

    iput-object p1, p0, Lads_mobile_sdk/re;->a:Landroid/content/Context;

    iput-object p3, p0, Lads_mobile_sdk/re;->b:Lads_mobile_sdk/i53;

    iput-object p2, p0, Lads_mobile_sdk/re;->c:Lads_mobile_sdk/p5;

    iput-object p4, p0, Lads_mobile_sdk/re;->d:Lcom/google/common/util/concurrent/ListeningExecutorService;

    return-void
.end method

.method public static a(Landroid/content/Context;Lads_mobile_sdk/p5;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1

    .line 2
    new-instance v0, Lb/Db;

    invoke-direct {v0, p0, p1}, Lb/Db;-><init>(Landroid/content/Context;Lads_mobile_sdk/p5;)V
...
.method public static a(Landroid/content/Context;Lads_mobile_sdk/p5;Landroidx/concurrent/futures/c$a;)Ljava/lang/Object;
    .locals 9
    ...
    invoke-virtual {p2, v2}, Landroidx/concurrent/futures/c$a;->c(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1}, Lads_mobile_sdk/p5;->J()Ljava/lang/String;
    ...
    invoke-virtual {v1, v7}, Lcom/google/common/io/BaseEncoding;->decode(Ljava/lang/CharSequence;)[B
    ...
    invoke-virtual {p1}, Lads_mobile_sdk/p5;->t()Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lcom/google/common/io/BaseEncoding;->decode(Ljava/lang/CharSequence;)[B
    ...
    new-instance v8, Lb/Eb;

    invoke-direct {v8, p2}, Lb/Eb;-><init>(Landroidx/concurrent/futures/c$a;)V

    const/4 v5, 0x0

    const/16 v6, 0x8

    invoke-static/range {v3 .. v8}, Lb/xb;->a(Landroid/content/pm/PackageManager;Ljava/lang/String;ZILjava/util/List;Landroid/content/pm/PackageManager$OnChecksumsReadyListener;)V
    :try_end_0
...
.method public static synthetic a(Landroidx/concurrent/futures/c$a;Ljava/util/List;)V
    .locals 6
    ...
    invoke-static {v3}, Lb/yb;->a(Ljava/lang/Object;)Landroid/content/pm/ApkChecksum;

    move-result-object v3

    invoke-static {v3}, Lb/zb;->a(Landroid/content/pm/ApkChecksum;)I
    ...
    invoke-static {v3}, Lb/Ab;->a(Landroid/content/pm/ApkChecksum;)[B
...
.method public final a()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 1
    iget-object v0, p0, Lads_mobile_sdk/re;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    iget-object v0, p0, Lads_mobile_sdk/re;->d:Lcom/google/common/util/concurrent/ListeningExecutorService;

    new-instance v1, Lb/Bb;

    invoke-direct {v1, p0}, Lb/Bb;-><init>(Lads_mobile_sdk/re;)V
...
.method public final a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, p0, Lads_mobile_sdk/re;->a:Landroid/content/Context;
...
.method public final a(Ljava/util/HashMap;)V
    ...
    .line 6
    invoke-virtual {p0, p1}, Lads_mobile_sdk/re;->c(Ljava/util/HashMap;)V
...
.method public final synthetic b()Ljava/lang/String;
    ...
    .line 1
    new-instance v0, Lb/Cb;

    invoke-direct {v0, p0}, Lb/Cb;-><init>(Lads_mobile_sdk/re;)V

    monitor-enter p0

    :try_start_0
    iget-object v1, p0, Lads_mobile_sdk/re;->b:Lads_mobile_sdk/i53;

    sget-object v2, Lads_mobile_sdk/vh0;->h:Lads_mobile_sdk/vh0;

    iget-object v3, p0, Lads_mobile_sdk/re;->a:Landroid/content/Context;

    iget-object v4, p0, Lads_mobile_sdk/re;->c:Lads_mobile_sdk/p5;

    invoke-static {v3, v4}, Lads_mobile_sdk/re;->a(Landroid/content/Context;Lads_mobile_sdk/p5;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object v3

    iget-object v4, p0, Lads_mobile_sdk/re;->d:Lcom/google/common/util/concurrent/ListeningExecutorService;
    ...
    invoke-virtual {v1, v2, v0}, Lads_mobile_sdk/i53;->a(Lads_mobile_sdk/vh0;Lcom/google/common/util/concurrent/ListenableFuture;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final c(Ljava/util/HashMap;)V
    ...
    iget-object v1, p0, Lads_mobile_sdk/re;->f:Lcom/google/common/util/concurrent/ListenableFuture;
